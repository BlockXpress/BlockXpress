...
contract BlockXpress is Ownable, IBEP20 {
    ...
    address constant public autoliquidityFeeReceiver = DEAD;
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _feeDenominator) public onlyOwner {
        ...
        require(totalFee < feeDenominator / 20, "Fees can not be more than 5%");
    
    }


    function setMarketingReceiver(address _marketingFeeReceiver) public onlyOwner {
